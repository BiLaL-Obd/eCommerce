<body>
    ...
    <nav class="navbar">
        <div class="container">
            <a class="navbar-brand font-size-24 fw-700 me-0" href="index.html">
            ...
            <ul class="navbar-nav flex-row justify-content-end flex-grow-1">
                <li class="nav-item">
                    <a href="#" class="nav-link p-2 px-1 px-sm-2 d-flex align-items-end position-relative">
                        ...
                        <i class="bx bx-heart font-size-30"></i> <span class="d-none d-sm-block">Favorite</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link p-2 d-flex align-items-end position-relative">
                        <span class="purchase-count font-size-10 d-flex align-items-center justify-content-center text-white bg-main end-0 rounded-circle position-absolute">5</span>
                        <i class="bx bx-shopping-bag font-size-30"></i>
                ...
                <li class="nav-item position-relative">
                    <div class="nav-link account-menu cursor-pointer p-2 d-flex align-items-end" href="#">
                        <i class="bx bx-user font-size-30"></i>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                                <form action="" class="row">
                                    ...
                                    <div class="col-12 mb-4">
                                        <a href="#" class="text-black-50 text-start font-size-14">Forget Password?</a>
                                    </div>
                ...
                <div class="collapse navbar-collapse bg-main-dark p-3 p-md-0 rounded-3" style="z-index: 99" id="headerMenu">
                    <ul class="navbar-nav justify-content-start flex-grow-1">
                        <li class="nav-item dropdown">
                            <a class="nav-link p-2 px-lg-3 text-uppercase d-flex align-items-center" aria-current="page" href="categories.html">
                                <i class="bx bx-dialpad-alt d-none d-md-block font-size-30"></i>
                                <span class="ps-lg-2 pe-4">Shop By Categories</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link p-2 px-lg-3 text-uppercase d-flex align-items-center" aria-current="page" href="index.html">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link p-2 px-lg-3 text-uppercase d-flex align-items-center" href="blogs.html">
                                Blogs
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link p-2 px-lg-3 text-uppercase d-flex align-items-center" href="about.html">About
                                Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link p-2 px-lg-3 d-flex text-uppercase align-items-center" href="contact.html">Contact
                                Us</a>
                        </li>
                    </ul>
                </div>
